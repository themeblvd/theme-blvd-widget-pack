...
class TB_Widget_Video extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('video_url'); ?>"><?php _e('Video URL:', 'themeblvd_widget_pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('description'); ?>"><?php _e('Description:', 'themeblvd_widget_pack'); ?></label>
	...
	function widget($args, $instance) {
		...
		if( ! $instance['video_url'] ) {
            _e('You forgot to enter a video URL.', 'themeblvd_widget_pack' );
            echo $after_widget;
            return;
		}
